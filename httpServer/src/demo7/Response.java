...
public class Response {
	...
	public void pushToClient(int code) throws IOException{
		...
		System.out.println("-----------------------------------------------------") ;
		System.out.println("headInfo: " + headInfo.toString()) ;
		System.out.println("headContent: " + headContent.toString()) ;
		System.out.println("-----------------------------------------------------") ;
		bw.flush();
		bw.close();
	}
//构建正文
	public Response print(String info){
		...
		this.len = this.len + info.getBytes().length ;
		return this ;
	}
	public Response println(String info){
		this.headContent.append(info) ;
		this.headContent.append(CRLF) ;
		this.len = this.len + (info + CRLF).getBytes().length ;
		return this ;
	}
